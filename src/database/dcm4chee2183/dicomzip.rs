...
pub async fn get_studies(pool: &MySqlPool, params: &StudyTokenParams, settings: &Settings) -> Result<Studies> {
    ...
    query_builder
        .select("
            ...
            patient.pat_id,
            patient.pat_name,
            patient.created_time as pat_created_time,
            patient.updated_time as pat_updated_time,
    ...
    while let Some(row) = rows.try_next().await? {
        ...
        let pat_created_time: NaiveDateTime = row.try_get("pat_created_time")?;
        let pat_updated_time: NaiveDateTime = row.try_get("pat_updated_time")?;
        ...
        */
        ...
        let instance_sop_iuid = row.try_get("sop_iuid")?;
