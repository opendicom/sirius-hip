...
use crate::api::StudyTokenParams;
use crate::errors::app_error::AppError;
use crate::pacs::repositories::study_repository::{StudyRepository, StudyTokenSearchCriteria};
use crate::application::models::{
    download_session::DownloadSession,
    download_session_file::DownloadSessionFile,
};

use crate::application::repositories::download_session_repository::DownloadSessionRepository;
use crate::utils;
...
pub enum StudyTokenOutput {
    ...
    Zip {
        filename: String,
        zip: crate::dicomzip::DicomStreamZip,
    },
}
...
impl WadoRef {
    fn from_row(row: &crate::pacs::read_models::StudyTokenRow) -> Self {
        Self {
...
struct StudyTokenPlan {
    ...
    rows: Vec<crate::pacs::read_models::StudyTokenRow>,
...
impl StudyTokenPresenter for OhifPresenter {
    async fn render(&self, plan: StudyTokenPlan) -> Result<StudyTokenOutput, AppError> {
        use crate::application::models::manifests::ohif::{OhifInstance, OhifInstanceMetadata, OhifSerie, OhifStudy, OhifStudies};
...
impl StudyTokenPresenter for ZipPresenter {
    async fn render(&self, plan: StudyTokenPlan) -> Result<StudyTokenOutput, AppError> {
        let mut zip = crate::dicomzip::DicomStreamZip::new();
...
fn build_wado_url(settings: &Settings, row: &crate::pacs::read_models::StudyTokenRow) -> String {
...
fn build_absolute_filesystem_path(
    settings: &Settings,
    row: &crate::pacs::read_models::StudyTokenRow,
) -> Option<PathBuf> {
